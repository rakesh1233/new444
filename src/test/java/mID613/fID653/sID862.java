...
public class dropscr2 extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterApplicationURL("https://www.makemytrip.com/");
        ...
        try
        {
            actions.Click(new dropPage2(driver).from0);
        ...
        try
        {
            actions.EnterData(new dropPage2(driver).from1,"goa");
        ...
        try
        {
            actions.Click(new dropPage2(driver).clickk);
        ...
        try
        {
            actions.EnterData(new dropPage2(driver).to1,"Bang");
        ...
        try
        {
            actions.Click(new dropPage2(driver).to2);
