...
public class xcxcxc extends  AllActions {
...
int len;
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterApplicationURL("https://demo.anhtester.com/basic-select-dropdown-demo.html");
        ...
        try
        {
            actions.SelectDropDownByText(new multisel(driver).newd,"Texas");
        ...
        try
        {
            actions.SelectDropDownByText(new multisel(driver).newd,"Ohio");
        ...
        try
        {
            actions.SelectDropDownByText(new multisel(driver).newd,"Florida");
        ...
        try
        {
            actions.DeselectDropDownByText(new multisel(driver).newd,"Texas");
        ...
        try
        {
            val12=actions.CheckForMultipleDropDown(new multisel(driver).newd);
        ...
        try
        {
            len=actions.GetAllDropDownOptionLength(new multisel(driver).newd);
