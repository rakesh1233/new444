...
public class dropScr extends  AllActions {
	...
	catch(Exception e)
	{
        ...
        try
        {
            actions.EnterApplicationURL("https://mdbootstrap.com/docs/standard/extended/multiselect/");
        ...
        try
        {
            actions.Click(new dropPage(driver).drop1i);
        ...
        try
        {
            actions.Click(new dropPage(driver).item2);
        ...
        try
        {
            actions.Click(new dropPage(driver).item3);
